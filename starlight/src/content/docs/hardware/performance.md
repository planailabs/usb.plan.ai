...
- **USB read speed** — and warn if a slow stick can't sustain the chosen tier.
- **RAM** — and pick role vs multi-model council accordingly.
- **GPU / VRAM** — and select the right acceleration backend.

...
**usb.plan.ai** is an open-source, portable AI stick with a fundamentally
...
includes the portable engine, the council orchestrator, the evals, and the vault.
This is a build-in-public spec; everything described here is the *target*. See
...
| **Open, forkable, extensible** | A council kit with recipes, model-packs, and plugins. Not a monolith. |

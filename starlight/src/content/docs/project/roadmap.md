...
| **v0.2: Council** | [Local role council](/council/local-council/) + [trace UI](/council/the-trace/) + demo prompts + [bias guard](/council/bias-and-confidence/) | The wow moment, runnable on weak hardware |
...
| **v0.4: Evals** | [`evals/`](/evals/overview/) Council-vs-Single + local multi-model Lab tier | Proof of the core claim |
...
> **Not on this roadmap:** browser-side WebGPU inference and a self-hosting board
> are scoped but unchosen. They live in [explorations](/architecture/explorations/),
> not here, until an [open question](/project/open-questions/) settles them.

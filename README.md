...
Offline by default; frontier models on opt-in.

> ## Status: v0.2 concept & spec, building in public
>
> **What exists today:** this repository's **website + documentation + the v0.2
> spec**. **What does *not* exist yet:** the product itself, including the portable
...
> Gemma is opt-in only: its license requires the notice file to travel
...
*Solver · Skeptic · Security · Summarizer*) for the same council UX with far
less RAM.
